...
function getTruppData(truppNum) {
  return {
    ...
    startPressure:
      document.getElementById(`trupp${truppNum}StartPressure`)?.value || "",
    startTime:
      document.getElementById(`trupp${truppNum}StartTime`)?.value || "",
    ...
    objective:
      document.getElementById(`trupp${truppNum}Objective`)?.value || "",
